package com.razerblade.waskito_1202154223_modul4;
...
public class listvieww extends AppCompatActivity {
    ...
    private String[] nama = {"MAHASISWA1","MAHASISWA2","MAHASISWA3","MAHASISWA4","MAHASISWA5","MAHASISWA6","MAHASISWA7","MAHASISWA8"
    ,"MAHASISWA9","MAHASISWA10","MAHASISWA11","MAHASISWA12"};
    @Override
